  ...
  return (
    <>
      <div className="h-[10%] bg-black flex justify-evenly items-center text-white px-4">
        <div className="hidden lg:flex items-center gap-4 w-[330px]">
          <img src={track.image} className="w-10" />
          <div>
        ...
        <div className="flex flex-col items-center gap-1 m-auto">
          ...
          <div className="flex items-center gap-5">
            ...
            <div 
              ref={seekBg} onClick={(e) => { seekSong(e) }}
        ...
        <div className="hidden lg:flex items-center gap-2 opacity-75 mt-3">
